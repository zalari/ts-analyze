import { CodeWalkerImplementation, CodeWalkerImplementationInterface, CodeWalkerResultBase, RepoAnalysisContextImplementation } from '@zalari/ts-analyze-base';
import { CompilerNodeToWrappedType, ts, Node } from 'ts-morph';
import { Fix, IOptions, RuleFailure, RuleWalker } from 'tslint';
import { WalkerLanguageService } from '@zalari/ts-analyze-base';
 ...
 */
export abstract class CodeAutoWalkerBaseTsLint extends RuleWalker implements CodeWalkerImplementationInterface {
  private __getWalkerType() { return 'auto'; };
